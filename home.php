...
<body>
  ...
  <p style="font-family: 'Josefin Sans', sans-serif; text-align: center; margin-left:70px; margin-top:-50px; font-size: 30px; width: 800px;"> We Are Hiring For Motion Graph & 3D animation</p>
  <p style="font-family: 'Josefin Sans', sans-serif; text-align: center; margin-left:-195px; margin-top: 20px; font-size: 30px; width: 800px;"> YOU ARE</p>
  <p style="font-family: 'Josefin Sans', sans-serif; text-align: center; margin-left:-180px; margin-top: 20px; font-size: 30px; width: 800px;"> THE MOST</p>
